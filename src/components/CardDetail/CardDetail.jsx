...
// Componente que se renderiza en /cruises/4
// tendremos que averiguar que /:id nos llegó > hook
export default function CardDetail() {
  ...
  React.useEffect(() => {
    ...
    fetch(`http://localhost:3001/cruises/${id}`)
      .then((res) => res.json())
      .then((data) => {
        // me llega la respuesta del servidor como "data"
        setCruiseDetail((estadoAnterior) => {
          console.log(data);
          return data;
        });
      })
